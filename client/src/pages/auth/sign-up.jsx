...
try {
  await axios.post(`${import.meta.env.VITE_API_BASE_URL}/sincrire` , {
    email ,
    username ,
    password
  })

  toast.success("Your registred successfully") ;
  setTimeout(()=>{
    history('/auth/sign-in')
  },3000);
} catch (error) {
  console.error(error)
  toast.error("There are some problems with registration") ;
